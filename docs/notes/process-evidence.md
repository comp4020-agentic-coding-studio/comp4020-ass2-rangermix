...
| The course's own logistics are documented, not inferred, and the calendar is generated rather than retyped | `/timetable/` first in the navigation; `spec/timetable.test.ts` | `55928a1` |
